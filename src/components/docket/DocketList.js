...
function DocketList() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const menuResponse = await axios.get(`https://namami-infotech.com/SAFEGUARD/src/menu/get_menu.php`);
                const menuData = menuResponse.data.data[0];
                setMenu(menuData);

                const checkpointsResponse = await axios.get(`https://namami-infotech.com/SAFEGUARD/src/menu/get_checkpoints.php`);
                ...
                const transactionResponse = await axios.get(`https://namami-infotech.com/SAFEGUARD/src/menu/get_transaction.php?menuId=${menuData.MenuId}`);
