  ...
  >
    ...
    >
      <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
        <Person /> <Typography variant="h6">Employee Details</Typography>
      </Box>
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} sx={{ mb: 2 }}>
          ...
          >
            <Avatar
              ...
              src={employee.Pic}
            >
              {!employee.Pic && employee.Name?.charAt(0)}
            </Avatar>
            <Box>
        ...
        <Grid item xs={12} md={6}>
          <Card variant="outlined" sx={{ p: 2 }}>
            ...
            <DetailRow icon={<Email />} label="Email" value={employee.EmailId} />
            <DetailRow
              icon={<CalendarToday />}
              label="Date of Birth"
              value={employee.DOB}
        ...
        <Grid item xs={12} md={6}>
          <Card variant="outlined" sx={{ p: 2 }}>
            ...
            <DetailRow icon={<Badge />} label="Role" value={employee.Role} />
            <DetailRow icon={<Schedule />} label="Shift" value={employee.Shift} />
            <DetailRow icon={<Schedule />} label="Week Off" value={employee.WeekOff} />
          </Card>
        </Grid>
        ...
        <Grid item xs={12}>
          <Card variant="outlined" sx={{ p: 2 }}>
            ...
            <Divider sx={{ mb: 2 }} />
            <DetailRow icon={<Badge />} label="Grade" value={employee.Grade} />
            <DetailRow icon={<Money />} label="UAN" value={employee.UAN} />
            <DetailRow icon={<Money />} label="ESI" value={employee.ESI} />
            <DetailRow icon={<CalendarToday />} label="Date of Joining" value={employee.JoinDate} />
          </Card>
        </Grid>
          ...
          <Card variant="outlined" sx={{ p: 2 }}>
            ...
            {employeeSalary ? (
              <Grid container spacing={2}>
                {[
                  { label: "Basic Salary", value: employeeSalary.basic_salary },
                  { label: "HRA", value: employeeSalary.hra },
                  { label: "Conveyance", value: employeeSalary.conveyance },
                  { label: "Special Allowance", value: employeeSalary.special_allowance },
                  { label: "Gross Salary", value: employeeSalary.gross_salary },
                ].map((item) => (
              ...
              <Alert severity="info">No salary information available.</Alert>
            )}
          </Card>
        </Grid>
        ...
        <Grid item xs={12}>
          <Card variant="outlined" sx={{ p: 2 }}>
            <Typography variant="h6" gutterBottom>
              {employeeSalary ? "Update Salary" : "Add Salary"}
            </Typography>
            <Divider sx={{ mb: 2 }} />
            <Grid container spacing={2}>
              <SalaryInputField
    ...
    >
      <CardContent sx={{ p: 1 }}>
        <Box display="flex" alignItems="center" justifyContent="space-between">
          ...
          <Person sx={{ fontSize: 22, color: "#8d0638ff" }} />
        </Box>
      </CardContent>
    </Card>
  </Grid>
      ...
      <CardContent sx={{ p: 1 }}>
        <Box display="flex" alignItems="center" justifyContent="space-between">
          <Box>
            ...
            <Typography variant="h6" fontWeight="bold" color="error.main" sx={{ lineHeight: 1 }}>
              {inactiveEmployees}
            </Typography>
            <Typography variant="caption" color="text.secondary">
              {totalEmployees > 0 ? `${((inactiveEmployees / totalEmployees) * 100).toFixed(1)}%` : "0%"}
            </Typography>
          </Box>
          <Close color="error" sx={{ fontSize: 22 }} />
        </Box>
      </CardContent>
    </Card>
  </Grid>
      ...
      <CardContent sx={{ p: 1 }}>
        <Box display="flex" alignItems="center" justifyContent="space-between">
          <Box>
            ...
            <Typography variant="h6" fontWeight="bold" color="warning.main" sx={{ lineHeight: 1 }}>
              {hrCount}
            </Typography>
            <Typography variant="caption" color="text.secondary">
              HR Dept
          ...
          <Work color="warning" sx={{ fontSize: 22 }} />
        </Box>
      </CardContent>
    </Card>
  </Grid>
            ...
            <Grid container spacing={3} sx={{ mt: 1 }}>
              ...
              <Grid item xs={12} md={6}>
                <Autocomplete
                  ...
                  value={
                    gradeOptions.find((g) => g.value === formData.Grade) || null
                  }
                  onChange={(_, newValue) =>
